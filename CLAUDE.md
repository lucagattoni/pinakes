...
- **[`plans/20260804_1016-template-release.md`](plans/20260804_1016-template-release.md) — every scheduled increment is shipped.** T1 in 0.17.0, T2 in 0.18.0, T3 in 0.19.0, T4 in 0.20.0, T5 in 0.20.1, T7 in 0.21.0 (landed 20260808 10:15). **What remains is gated, not scheduled**: T6 (the `sqlite-vec` tier) and T8 (a second template) each ship only if their own gate passes, and either may never be built — so **the release name stays in the unbuilt-work table above** (D-9). Read a gate's conditions before assuming an increment is next.
