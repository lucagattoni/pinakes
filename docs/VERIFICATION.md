...
| …and the gate cannot report a pass it did not earn | fix | `tests/test_wheel_import_gate.py::test_an_allowance_cannot_excuse_a_module_failing_on_a_different_library` + `::test_a_required_module_may_not_also_be_allowed_to_fail` + `::test_the_real_package_is_refused_from_the_source_tree` |
