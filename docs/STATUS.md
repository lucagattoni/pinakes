...
**Latest release: 0.28.2** · last reviewed 20260823 02:47
...
| `pnk sync` | shipped | `--rebuild`, `--scan-links`, `--sidecars-only`, `--index-only`, `--extract`, `--force`, `--clear-cache[=paid|transcripts]` |
