...
**Latest release: 0.31.0** — ⏸ **landed on `main`; `pip install pinakes` still gets 0.30.2.** · last reviewed 20260830 14:46
...
| `pnk sync` | shipped | `--rebuild`, `--scan-links`, `--sidecars-only`, `--index-only`, `--extract`, `--force`, `--clear-cache` (bare, `=all`, `=paid`, `=transcripts`) |
