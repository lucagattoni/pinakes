...
- **[Open corrections](#open-corrections)** — **three live as of 20260825 19:02.** The list emptied
...
- **🛑 One thing is scheduled, as of 20260825: the exposure plan**
  ...
  *and* ignored — **unconditionally**. D-34 closed as *promises only*.
  ...
  with an example the constant refuses. T6 waits on a **trigger** (a queried KB past
