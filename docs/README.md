...
`plans/` holds more than one kind of file. **As of 20260825 one file proposes work: the exposure
plan at the top of the table.** Its § X1 is buildable now and needs no decision; everything else
in it waits on D-31 to D-34, which are *proposed and not taken*. Every other file below is closed,
