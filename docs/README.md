...
`plans/` holds more than one kind of file, and **as of 0.26.0 none of it is scheduled unbuilt
work** — the deep release closed with E7 and every other file below is closed, answered, deferred
or proposed-unscheduled. Read that as *the next thing to build has not been planned yet*, never as
*nothing to do*; Part 5 of [ROADMAP.md](ROADMAP.md) holds the candidates. Never take "the newest
