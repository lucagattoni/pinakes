...
| [`20260831_2115-stale-entry-points-audit.md`](../plans/20260831_2115-stale-entry-points-audit.md) | **An audit of what a cleared session reads first, preserved verbatim from the scratchpad it would have died in** — 46 of its 62 findings had no other home. **The 15 blockers are CLOSED** and each was re-verified individually against `6a86482`. **What is live is the residue: 13 misleading, 33 cosmetic** — a worklist, never an alarm, and **none of it changes what a cleared session does**. Its own limit is why the count is usable: *"62 is what survived an adversary told to refute, not ground truth."* **Line numbers have shifted — locate by content** |
